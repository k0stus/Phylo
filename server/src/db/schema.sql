...
CREATE TABLE IF NOT EXISTS battles (
  ...
  user_a_score          REAL,
  user_b_score          REAL,
  user_a_category_scores TEXT, -- JSON
  user_b_category_scores TEXT, -- JSON
  winner_id             TEXT,   -- NULL = draw, set when complete
  status                TEXT NOT NULL DEFAULT 'pending', -- pending|analyzing|complete|abandoned
  created_at            INTEGER NOT NULL DEFAULT (unixepoch()),
